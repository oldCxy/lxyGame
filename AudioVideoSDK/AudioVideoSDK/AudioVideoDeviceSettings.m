 ...
 *  设备权限设置
 */
@interface AudioVideoDeviceSettings()

@end

@implementation AudioVideoDeviceSettings
...
+ (void)testLibraryAuthor:(AVSDKTSAssetsManagerAuthorBlock)authorBlock;
{
    ...
    [PHPhotoLibrary requestAuthorization:^(PHAuthorizationStatus status) {
        ...
        if (status != PHAuthorizationStatusAuthorized) {
            NSInteger code = AVAssetsAuthorizationErrorNotDetermined;
            switch (status) {
                case AVAssetsAuthorizationErrorRestricted:
                    code = AVAssetsAuthorizationErrorRestricted;
                    break;
                case PHAuthorizationStatusDenied:
                    code = AVAssetsAuthorizationErrorDenied;
                    break;
                default:
                    break;
            }
