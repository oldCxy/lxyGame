...
#import "VideoFirstRecorder.h"
#import <AVFoundation/AVFoundation.h>
#import <AssetsLibrary/AssetsLibrary.h>

@interface VideoFirstRecorder ()
...
@implementation VideoFirstRecorder
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _recordPosition = VideoRecordPositionFront;
        _recordVoiceType = VideoRecordVoiceSoundType;
        _recordOutputType = VideoRecordMovieFileOutput;
...
- (AVCaptureOutput *)captureOutput{
    ...
    if (!_captureOutput) {
        ...
        if (_recordOutputType == VideoRecordMovieFileOutput) {
